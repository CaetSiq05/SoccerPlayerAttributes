...
void showMenu(HashTable& playerTable) {
    while (true) {
        ...
        cout << "7. Executar benchmark de desempenho (com uso de memória e escalabilidade)\n";
        cout << "8. Sair\n";
        cout << "==============================\n";
